...
namespace MASA.OfficialWebsite.WebApp.Data;
...
public static class ActivityData
{
    ...
    public static readonly Dictionary<string, ActivityDetail> AllActivityDetails = new()
    {
        ...
        {
            "meetup-230520",
            new Models.ActivityDetail("//player.bilibili.com/player.html?aid=443968619&bvid=BV1RL411B7Lh&cid=1138061328&page=1",
